              ...
              <AnimatePresence>
                {togglePopup && (
                  ...
                  >
                    ...
                    <button className='w-full text-left px-4 py-3 text-sm text-zinc-700 hover:bg-zinc-50 transition-colors flex items-center gap-2'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          >
            ...
            <div className='mt-9 flex flex-wrap items-center justify-center gap-4'>
              {user.name ? (
                <button className='hero-btn hero-btn-primary text-base px-8 py-3.5'>
                  Go to Dashboard
                </button>
              ) : (
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          >
            ...
            <div className='relative mt-8 flex flex-wrap justify-center gap-4'>
              {user.name ? (
                <button className='px-8 py-3.5 rounded-xl bg-white text-indigo-600 font-semibold hover:bg-indigo-50 transition-colors shadow-lg'>
                  Go to Dashboard
                </button>
              ) : (
                <button
